...
{
    private static final LatLng DEFAULT_LOCATION = new LatLng(37.95, 127.08);
...
/*
        mFusedLocationClient = LocationServices.getFusedLocationProviderClient(getActivity());
       // 마지막으로 알려진 위치를 요청하는 경우 전화만하면됩니다.
    ...
    public void onDestroy() {
        ...
        if ( googleApiClient != null ) {
            ...
            if ( googleApiClient.isConnected()) {
                ...
                //mFusedLocationClient.removeLocationUpdates(setCurrentLocation());
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        // 매끄럽게 이동함
        googleMap.animateCamera(CameraUpdateFactory.zoomTo(90));
